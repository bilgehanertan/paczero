#!/bin/bash
# 6.7B LoRA rank ablation r=16
# Paper reference: appendix.tex Table rank-ablation
# Recipe: lr=1e-3 c=25 T=1000 MI=0.33 r=16 M=128 seed=0
source "$(dirname "${BASH_SOURCE[0]}")/../_common.sh"
OUT_DIR="$OUT_BASE/rankabl_sst2_6p7b_lora_mi0p33_r16_s0"; mkdir -p "$OUT_DIR/checkpoints"
