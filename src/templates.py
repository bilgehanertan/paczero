...
class MNLITemplate(Template):
    ...
    def encode(self, sample):
        premise = sample.data['premise']
        hypothesis = sample.data['hypothesis']
        return f"{premise} {hypothesis} The answer is"

    def verbalize(self, sample, candidate):
        premise = sample.data['premise']
        hypothesis = sample.data['hypothesis']
        return f"{premise} {hypothesis} The answer is {self.verbalizer[candidate]}"

    def encode_sfc(self, sample):
        return f" The answer is"

    def verbalize_sfc(self, sample, candidate):
        return f" The answer is {self.verbalizer[candidate]}"
...
class trecTemplate(Template):
    verbalizer = {0: "Abbreviation", 1: "Description", 2: "Entity", 3: "Human", 4: "Location", 5: "Number"}

    def encode(self, sample):
        text = sample.data['text']
        return f"{text} The answer type is"

    def verbalize(self, sample, candidate):
        text = sample.data['text']
        return f"{text} The answer type is {self.verbalizer[candidate]}"

    def encode_sfc(self, sample):
        return f" The answer type is"

    def verbalize_sfc(self, sample, candidate):
        return f" The answer type is {self.verbalizer[candidate]}"
